...
# python export_inference_graph.py --input_type image_tensor --pipeline_config_path training_rcnn/faster_rcnn_inception_v2_coco.config --trained_checkpoint_prefix training_rcnn/model.ckpt-130000 --output_directory trained-inference-graphs/output_inference_graph_rcnnv13v2.pb
